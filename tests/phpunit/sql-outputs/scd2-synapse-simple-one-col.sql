...
SELECT
    ...
    (SELECT value FROM properties WHERE "key" = 'date') AS "start_date",
...
SELECT
    ...
    (SELECT value FROM properties WHERE "key" = 'date') AS "end_date",
...
WHERE
    ...
    AND snapshot."start_date" != (SELECT value FROM properties WHERE "key" = 'date');
...
SELECT
    ...
    snapshot."start_date",
    -- The end date is set to "(SELECT value FROM properties WHERE "key" = 'date')" ("keep_del_active" = false). --
    (SELECT value FROM properties WHERE "key" = 'date') AS "end_date",
